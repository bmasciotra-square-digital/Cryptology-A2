...
constexpr int LEFT_BLOCK_SIZE = 32;
constexpr int RIGHT_BLOCK_SIZE = 32;
...
string f_function(const string &right32, const string &key48) {
    ...
    const string expanded = permute(right32, E_EXPANSION, 48);
...
string convert_to_hex(const string &bits) {
    ...
    string converted;
    const size_t hex_amount = bits.size() / 4;
